...
if ($_SESSION['active']==false){
  header("location: loggedoutTenant.html");
}
?>
...
<body>
  ...
  <section class="probootstrap-cover overflow-hidden relative" style="background-image: url('images/bg_1.jpg');" data-stellar-background-ratio="0.5"
    ...
    <div class="container">
          ...
          <li class="details">Tenant: '.$_SESSION["Username"].'</li>';
          ?>

      <div class="row ">
        <div class="col-md-3" "navigate">
          <ul class="side-navigation">
            <li class="li-navigate" class="myAnchor"  onclick="noticeBoard()"> NoticeBoard</li>
            <li  class="li-navigate"  onclick="chats()" class="myAnchor">  Chats</li>
            <li  class="li-navigate" onclick="editProfile()" class="myAnchor"> Edit Profile</li>
